...
integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">Hello DevOps Students of RMIT Vietnam!!! This is a new change in Week 8!</h1>
      <p class="lead">This is a very simple website template that uses bootstrap CSS framework! This is a new code to push for the github SCM 
poll!</p>
      ...
      <a class="btn btn-primary btn-lg" href="https://www.rmit.edu.vn/about-us/schools-and-centres/school-of-science-engineering-and-technology" 
role="button">Learn more about SSET</a>
      <a class="btn btn-success btn-lg" href="https://getbootstrap.com/docs/4.3/getting-started/introduction/" role="button">Learn more about 
Bootstrap CSS Framework</a>
    </div>
